...
namespace Xi.Server.Base
{
		...
		, IDisposable
	{
						...
						uint listType, uint listKey, StandardMib mib)
		{
			...
			_ListLock = (unchecked((int)DateTime.UtcNow.Ticks & 0x7FFFFFF));
		}
		...
		/// 
		/// </summary>
		protected object _ListLock = new Nullable<long>();
		...
		/// </summary>
		public void SetLastPollTime() { _lastPollTime = DateTime.UtcNow; }
