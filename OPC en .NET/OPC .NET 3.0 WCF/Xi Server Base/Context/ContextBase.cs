...
namespace Xi.Server.Base
{
		...
		where TList : ListRoot
	{
		...
		/// </summary>
		protected object ContextLock = new Nullable<long>();
		...
		{
			ContextLock = (long)rand.Next(1, 0xFFF);
		...
		/// <summary>
		/// The endpoint entry for the connected ResourceManagement endpoint.
		/// </summary>
		protected EndpointEntry<TList> _connectedResourceManagementEndpoint;
		...
		public void CreateConnectedResourceManagementEndpoint(EndpointDefinition epDefinition)
		{
			lock (ContextLock)
			{
				_connectedResourceManagementEndpoint = new EndpointEntry<TList>(epDefinition);
		...
		/// </summary>
		public bool Concluded { get { return _concluded; } }
		protected bool _concluded;
