...
namespace Xi.Server.Base
{
									...
									where TList : ListRoot
	{
		...
		{
			using (EnterMethod("IRead.ReadData", contextId, listId))
			{
				try
				{
		...
		{
			using (EnterMethod("IRead.ReadJournalDataForTimeInterval", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadJournalDataNext", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadJournalDataAtSpecificTimes", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		JournalDataChangedValues[] IRead.ReadJournalDataChanges(string contextId, uint listId,
			...
			uint numValuesPerAlias, List<uint> serverAliases)
		{
			using (EnterMethod("IRead.ReadJournalDataChanges", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		JournalDataChangedValues[] IRead.ReadJournalDataChangesNext(string contextId, uint listId,
			uint numValuesPerAlias)
		{
			using (EnterMethod("IRead.ReadJournalDataChangesNext", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadCalculatedJournalData", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadJournalDataProperties", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadEvents", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadJournalEvents", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
		...
		{
			using (EnterMethod("IRead.ReadJournalEventsNext", contextId, listId))
			{
				try
				{
					TContext context = ContextManager<TContext, TList>.LookupContext(contextId, false);
