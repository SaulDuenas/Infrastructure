...
namespace Xi.Contracts
{
	...
	public interface IResourceManagement
	{
		...
		/// zero causes the server to use its default timeout.  If the 
		/// underlying WCF connection is inadvertantly terminated, the 
		/// client may reopen the context within this time-out period 
		/// using the ReInitiate() method.
		/// </param>
