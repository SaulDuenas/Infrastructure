...
Begin VB.Form Principal 
   ...
   Begin VB.Label Label20 
      Caption         =   "Ver. 24082011r01-n38-balaOFF"
      Height          =   735
      Left            =   9600
      TabIndex        =   65
      Top             =   8160
...
fr_err = "Se Genero un error conexion de datos con el PLC"
               Error_formato.Show
     Open "C:\cont\balas.err" For Append Access _
            Write Shared As #2
