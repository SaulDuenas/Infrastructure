...
Sub FGEscribeDato(phGrid As Control, pRow%, pCol%, pDato As Variant)
...
'   pEqual%     (IN)   True= Igual, False= Diferente
...
Public Function FGBuscarDato(poGrid As MSFlexGrid, pnColumna As Long, psDato As String, Optional pbOcultos As Boolean = False) As Boolean
 ...
 Dim C As Long            'Índice de Columnas.
   ...
   If Not lbOk Then
      Call FGSelectRow(poGrid, lnFila)
      Beep
   End If
...
Public Function GridColumnatoString(phGrid As Control, pSeparador As String, pColumna As Integer, ParamArray pFiltros() As Variant) As String
