...
#Region "ADO.NE Data Services URLs"
    ...
    Private codeFxUri As String = _
    "http://localhost:8889/CodeFx.svc"
#End Region
...
#Region "Update and query methods"
    ...
    Private Sub UpdateQueryNonRelationalData()
        ...
        Dim svc As New DataServiceContext(New Uri(codeFxUri))
        ...
        Dim newCategory As New CodeFxService.Category() With _
        ...
        Dim categories = svc.Execute(Of CodeFxService.Category)(New Uri( _
        ...
        Dim projects = svc.Execute(Of CodeFxService.Project)(New Uri( _
        ...
        For Each p In projects
            ...
            Dim category As CodeFxService.Category = svc.Execute(Of  _
                CodeFxService.Category)(uri).First()
        ...
        Console.WriteLine("Group the CodeFx projects by category name:")
