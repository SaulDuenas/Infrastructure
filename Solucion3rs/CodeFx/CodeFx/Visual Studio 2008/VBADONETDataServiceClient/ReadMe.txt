...
A. Creating an ordinary Visual Basic.NET Console Application and adding the 
   ...
   3. In the Add Service Reference dialog, click Discover, add the three 
      ADO.NET Data Services CodeFx.svc, SchoolLinqToEntities.svc, and 
      SchoolLinqToSQL.svc, rename the Namespace of the services to 
      CodeFxService, SchoolLinqToEntities, and SchoolLinqToSQLService 
      respectively.
...
Query Expression Syntax (ADO.NET Data Services Framework)
http://msdn.microsoft.com/en-us/library/cc668784.aspx

Query Expression Functions (ADO.NET Data Services Framework)
...
URI Format for Addressing Resources (ADO.NET Data Services Framework)
