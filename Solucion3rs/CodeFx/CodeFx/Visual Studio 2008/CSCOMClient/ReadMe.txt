...
Step3. Create an ATLDllCOMServer.ATLSimpleObjectSTA COM object.

	ATLDllCOMServerLib.ATLSimpleObjectSTA simpleObj = 
		new ATLDllCOMServerLib.ATLSimpleObjectSTA();

Step4. Register the events of the COM object,

	simpleObj.FloatPropertyChanging += new ATLDllCOMServerLib.
		_IATLSimpleObjectSTAEvents_FloatPropertyChangingEventHandler(
...
Step2. Create an ATLDllCOMServer.ATLSimpleObjectSTA COM object. We use 
