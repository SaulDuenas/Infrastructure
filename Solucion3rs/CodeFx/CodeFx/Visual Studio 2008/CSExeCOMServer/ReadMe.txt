...
D. Adding the COM-visible class CSSimpleObject

Step1. Define a "public" COM-visible interface ICSSimpleObject to describe 
...
Step2. Inside the interface ICSSimpleObject, define the prototypes of the 
properties and methods to be exported. 

Step3. Define a "public" COM-visible interface ICSSimpleObjectEvents to 
...
Step4. Inside the interface ICSSimpleObjectEvents, define the prototype of
...
Step6. Define a "public" COM-visible class CSSimpleObject that implements 
the interface ICSSimpleObject, and inherits from ReferenceCountedObject. 
...
Interface. This ensures that the ICSSimpleObject interface is the default 
...
Step7. Make sure that the constructor of the class CSSimpleObject is not 
...
Step8. Inside CSSimpleObject, implement the interface ICSSimpleObject by 
writing the body of the property FloatProperty and the methods HelloWorld,  
GetProcessThreadID.

E. Registering CSSimpleObject in the registry
...
Step1. Inside CSSimpleObject, add the functions Register and Unregister, and 
...
F. Registering ClassFactory of CSSimpleObject
...
Step2. Register the class factory of CSSimpleObject using the standard  
...
register COM objects is a technique which is not supported.
	...
	// Register the CSSimpleObject class object on start
...
Step3. Revoke the registration of CSSimpleObject using the 
...
The commands register the COM-visible types (e.g. CSSimpleObject) in the 
registry.
