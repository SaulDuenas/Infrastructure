...
* 2. Associating core editor with file extension: .codefx
...
namespace CodeFx.CSVSPackageInvokeCoreEditor
{
    /// <summary>
    ...
    [ProvideLoadKey("Standard", "1.0", "VSPackageInvokeCoreEditor", "CodeFx", 1)]
    [Guid(GuidList.guidCSVSPackageInvokeCoreEditorPkgString)]

    // Register EditorFactory with extension .codefx, this enables VS to trigger editor
    // creation when the file is opened
    [ProvideEditorExtension(typeof(EditorFactory),
          ".codefx", 32, NameResourceID = 101)]
