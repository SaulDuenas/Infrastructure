...
*
* This LinqToCSVForm creates a CSV document based on some of the CodeFx 
* project information and uses the simple LINQ to CSV library to read and 
...
*
* History:
* * 6/12/2009 10:30 PM Lingzhi Sun Created
\***************************************************************************/
...
namespace CSLinqExtension
{
    public partial class LinqToCSVForm : Form
    {
        ...
        private string filePath = "CodeFx.csv";
        ...
        /// <summary>
        /// This method creates a CSV file based on some of the CodeFx project
        /// information.
        /// </summary>
        private void CreateCSVFile()
        {
            ...
            try
            {
                using (StreamWriter writer = new StreamWriter(filePath))
                {
                    ...
                    writer.WriteLine("#CodeFx Projects (format: Project Name, Program Language, Description, Owner)");
                ...
                MessageBox.Show("CodeFx.csv created successfully!");
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
    ...
    #region The CodeFx project class
