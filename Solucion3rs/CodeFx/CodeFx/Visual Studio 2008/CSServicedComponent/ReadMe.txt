...
Program ID: CSServicedComponent.CSSimpleObject
CLSID_CSSimpleObject: 14EAD156-F55E-4d9b-A3C5-658D4BB56D30
IID_ICSSimpleObject: 2A59630E-4232-4582-AE47-706E2B648579
DIID_ICSSimpleObjectEvents: A06C000A-7A85-42dc-BA6D-BE736B6EB97A
...
the COM interface of the coclass CSSimpleObject. Inside the interface, define 
the prototypes of the properties and methods to be exported.

Step2. Define a "public" COM-visible interface ICSSimpleObjectEvents to 
describe the events the coclass can sink.

Step3. Define a "public" COM-visible class CSSimpleObject that implements 
the interface ICSSimpleObject, and inherits from
...
Step4. Add the Description attribute. 
	...
	[assembly: Description("COM+ examples of CodeFx")]
