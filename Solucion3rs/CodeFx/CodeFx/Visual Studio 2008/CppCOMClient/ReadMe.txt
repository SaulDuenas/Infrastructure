...
consume the COM object ATLDllCOMServer.ATLSimpleObjectSTA. The raw automation 
...
A. Creating the ATLDllCOMServer.ATLSimpleObjectSTA COM object using C++ and  
...
B. Creating the CSDllCOMServer.CSSimpleObject2 COM object using the #import 
directive and smart pointers (ImportDirecive.h/cpp)
...
original interface name (i.e. ICSSimpleObject2) with a "Ptr" suffix. We can 
use either the constructor of the smart pointer class or its CreateInstance
method to create the COM object.
