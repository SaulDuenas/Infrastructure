...
efficient, flexible, lightweight COM components. ATLExeCOMServer provides the 
our-of-process server objects that are implemented in an EXE and are run in a
separate process space.

ATLExeCOMServer exposes the following items:
