...
On Excel Ribbon -> CodeFx Samples, click Interop Form (C#) button.


/////////////////////////////////////////////////////////////////////////////

The access the VBA object model from VSTO code, you must reference the
following assembly:

Microsoft.Vbe.Interop

Starting from Office 2003, programmatically access VBA project object model
is disabled by default. Use must enable this option either manually in Office
application settings or programmatically editing the registry
(see VBEHelper.cs).
