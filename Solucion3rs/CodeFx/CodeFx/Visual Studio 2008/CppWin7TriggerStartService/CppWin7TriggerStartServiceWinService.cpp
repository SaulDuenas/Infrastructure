// CppWin7TriggerStartService.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "CppWin7TriggerStartServiceWinService.h"

using namespace CppWin7TriggerStartService;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "CppWin7TriggerStartService.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew CppWin7TriggerStartServiceWinService());
	}
}
