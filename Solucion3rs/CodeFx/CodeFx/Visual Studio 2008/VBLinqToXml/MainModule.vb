...
' 
' History:
' * 5/07/2009 09:00 PM Lingzhi Sun Created
'***************************************************************************'
...
#Region "In-Memory Object XML Methods"
    ...
    Function CreateObjects() As Category()
        ...
        ' information. Here we use the new features of VB.NET 9.0, object 
...
Class Category
    ...
    ' The array of CodeFx projects objects property
    ...
    ' The array of CodeFx projects objects field
