...
'Original file name:
'Generation date: 9/16/2009 7:57:59 PM
Namespace CodeFxService
    '''<summary>
    '''There are no comments for CodeFxProjects in the schema.
    '''</summary>
    Partial Public Class CodeFxProjects
        ...
        End Sub
        Private Shared ROOTNAMESPACE As String = GetType(CodeFxService.CodeFxProjects).Namespace.Remove(GetType(CodeFxService.CodeFxProjects).Namespace.LastIndexOf("CodeFxService"))
        '''<summary>
        ...
        Protected Function ResolveTypeFromName(ByVal typeName As String) As Global.System.Type
            If typeName.StartsWith("VBADONETDataService", Global.System.StringComparison.OrdinalIgnoreCase) Then
                Return Me.GetType.Assembly.GetType(String.Concat(String.Concat(ROOTNAMESPACE, "CodeFxService"), typeName.Substring(19)), true)
            End If
            Return Nothing
        End Function
        '''<summary>
        ...
        Protected Function ResolveNameFromType(ByVal clientType As Global.System.Type) As String
            If clientType.Namespace.Equals(String.Concat(ROOTNAMESPACE, "CodeFxService"), Global.System.StringComparison.OrdinalIgnoreCase) Then
