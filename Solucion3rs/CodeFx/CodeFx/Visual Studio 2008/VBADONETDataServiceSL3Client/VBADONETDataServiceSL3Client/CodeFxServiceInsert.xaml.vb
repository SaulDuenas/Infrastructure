'***************************** Module Header ******************************\
'* Module Name:	CodeFxServiceInsert.xaml.vb
'* Project:		VBADONETDataServiceSL3Client
'* Copyright (c) Microsoft Corporation.
'* 
'* CodeFxServiceInsert.xaml.vb demonstrates how to call ASP.NET Data Service
...
Imports VBADONETDataServiceSL3Client.CodeFxService
Imports System.Data.Services.Client

Partial Public Class CodeFxServiceInsert
    Inherits UserControl
    ' The URL of ADO.NET Data Service
    Private Const _codeFxUri As String = "http://localhost:8889/CodeFx.svc"
    ' returnedCategory => _context ={via async REST call}=> ADO.NET Data Service
    Private _context As CodeFxProjects
    Public Sub New()
        InitializeComponent()
        AddHandler Me.Loaded, AddressOf CodeFxServiceInsert_Loaded
    End Sub

    Private Sub CodeFxServiceInsert_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
        LoadData()
    End Sub
    ...
    Private Function ChangesSaved(ByVal result As IAsyncResult)
        Dim svcContext As CodeFxProjects = TryCast(result.AsyncState, CodeFxProjects)
