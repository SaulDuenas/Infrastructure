...
* .cfx files. After installing the icon handler, "C#.cfx" files show CodeFx 
* C# icon, "VB.cfx" files show CodeFx VB icon, "C++.cfx" files show CodeFx 
* C++ icon, and other .cfx files show CodeFx icon in Microsoft Windows 
* Explorer. 
* 
...
* 
* History:
* * 9/5/2009 7:30 PM Jialiang Ge Created
\***************************************************************************/
...
//	{
//		// C#.cfx -> IDI_CODEFXCS
//		uIconID = IDI_CODEFXCS;
//	}
//	else if (_tcscmp(szFileName, _T("VB")) == 0)
//	{
//		// VB.cfx -> IDI_CODEFXCS
//		uIconID = IDI_CODEFXVB;
//	}
//	else if (_tcscmp(szFileName, _T("C++")) == 0)
//	{
//		// C++.cfx -> IDI_CODEFXCPP
//		uIconID = IDI_CODEFXCPP;
//	}
//	else
//	{
//		// Other file name.cfx -> IDI_CODEFX
//		uIconID = IDI_CODEFX;
//	}
//
