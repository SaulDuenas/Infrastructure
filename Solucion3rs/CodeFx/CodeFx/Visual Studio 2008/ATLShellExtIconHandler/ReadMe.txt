...
.cfx files. After installing the icon handler, "C#.cfx" files show CodeFx C# 
icon, "VB.cfx" files show CodeFx VB icon, "C++.cfx" files show CodeFx C++ 
icon, and other .cfx files show CodeFx icon in Microsoft Windows Explorer. 
