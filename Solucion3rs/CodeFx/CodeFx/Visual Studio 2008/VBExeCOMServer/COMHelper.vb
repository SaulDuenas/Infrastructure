...
' 
' History:
' * 11/15/2009 1:14 PM Jialiang Ge Created
'***************************************************************************'
...
Friend Class COMNative
    ...
    ByVal dwClsContext As CLSCTX, ByVal flags As REGCLS, <Out()> ByRef lpdwRegister As Integer) _
    As Integer
    End Function
    ...
    ''' <returns></returns>
    <DllImport("ole32.dll")> _
    Public Shared Function CoRevokeClassObject(ByVal dwRegister As Integer) As UInt32
    End Function
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Const GuidIClassFactory As String = "00000001-0000-0000-C000-000000000046"

    ''' <summary>
    ''' Interface Id of IUnknown
    ''' </summary>
    ''' <remarks></remarks>
    Public Const GuidIUnknown As String = "00000000-0000-0000-C000-000000000046"
