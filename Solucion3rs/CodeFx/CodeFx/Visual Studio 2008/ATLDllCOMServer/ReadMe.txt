...
efficient, flexible, lightweight COM components. ATLDllCOMServer provides the 
in-process server objects that are implemented in a DLL and are run in the 
process space of the controller. 

ATLDllCOMServer exposes the following items:
...
Step2. Right-click _IATLSimpleObjectSTAEvents. On the shortcut menu, click 
...
_IATLSimpleObjectSTAEvents dispinterface in the ATLDllCOMServer.idl file 
...
generated (ie. CProxy_IATLSimpleObjectSTAEvents in this example) in the file 
