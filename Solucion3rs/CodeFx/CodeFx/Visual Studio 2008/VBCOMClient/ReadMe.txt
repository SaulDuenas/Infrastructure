...
Step3. Create an ATLDllCOMServer.ATLSimpleObjectSTA COM object with the support 
of events (WithEvents).

	Dim WithEvents simpleObj As New ATLDllCOMServerLib.ATLSimpleObjectSTA
...
Step2. Create an ATLDllCOMServer.ATLSimpleObjectSTA COM object. The object  
