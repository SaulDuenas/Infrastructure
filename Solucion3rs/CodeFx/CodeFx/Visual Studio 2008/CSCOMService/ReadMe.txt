...
E. Adding the COM-visible class CSSimpleObject
...
Step5. Define a "public" COM-visible class CSSimpleObject that implements 
the interface ICSSimpleObject. Attach the attribute 
...
the ICSSimpleObject interface is the default interface. In addition, specify 
...
Step6. Make sure that the constructor of the class CSSimpleObject is not 
...
Step7. Inside CSSimpleObject, implement the interface ICSSimpleObject by 
writing the body of the property FloatProperty and the methods HelloWorld,  
GetProcessThreadID.

F. Registering CSSimpleObject in the registry
...
G. Registering ClassFactory of CSSimpleObject
