...
stack. Unlike the heap, it does not expand as needed. Its initial size can be 
changed via /STACK linker switch (See Project Property Pages / Linker / 
...
You can run the example in either Debug or Release mode. In this example, we 
disable the optimizations in the Release configuration. It makes sure that 
the sample functions and the memory allocations are processed.
