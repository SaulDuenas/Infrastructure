...
* 
* History:
* * 5/07/2009 03:00 PM Lingzhi Sun Created
\***************************************************************************/
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        // see CSLinqToSQL project in CodeFx.)
        //
        ...
        /////////////////////////////////////////////////////////////////////
        // Edit the CodeFx.xml XML document created by in-memory objects. 
    ...
    // String array of the CodeFx contributors
    ...
    /// <summary>
    /// This method creates the in-memory objects based on the CodeFx 
    /// examples information
    /// </summary>
    /// <returns>The array of in-memory objects</returns>
    private static Category[] CreateObjects()
    {
        // Build the array of in-memory objects based on the CodeFx examples
        // information. Here we use the new features of C# 3.0, object 
        // initializers and collection initializers to build the objects.
    ...
    /// SQLServer2005DB database in CodeFx
    /// </summary>
...
// The CodeFx projects category class
public class Category
{
    // The category name
    public string Name { get; set; }

    // The array of CodeFx projects objects
    public Project[] Projects { get; set; }
}

// The CodeFx project class
...
// The enum of CodeFx contributors's display names on CodePlex
public enum Owners
{
