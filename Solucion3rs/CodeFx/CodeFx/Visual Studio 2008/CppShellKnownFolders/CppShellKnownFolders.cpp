...
* 
*   1 Register and create a known folder named "CodeFx KnownFolder" under 
*   the user profile folder: C:\Users\<username>\CodeFxKnownFolder. The 
*   known folder displays the localized name "CodeFx KnownFolder 
*   LocalizedName", and shows a folder icon with the CodeFx logo. 
...
* 
* History:
* * 9/20/2009 09:00 PM Jialiang Ge Created
\***************************************************************************/
