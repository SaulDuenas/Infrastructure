/****************************** Module Header ******************************\
* Module Name:	CodeFx.svc.cs
* Project:		CSADONETDataService
* Copyright (c) Microsoft Corporation.
* 
* CodeFx.svc demonstrates the ADO.NET Data Service for non-relational data
* source.  The non-relational data source is some in-memory objects which
* hold the CodeFx projects information. The non-relational entity class also
...
* 
* History:
* * 7/22/2009 03:00 PM Lingzhi Sun Created
* * 8/20/2009 01:00 AM Lingzhi Sun Edited
\***************************************************************************/
...
{
    public class CodeFx : DataService<CodeFxProjects>
    {
    ...
    // CodeFx project entity class with DataServiceKey 'ProjectName'
    ...
    // CodeFx project category entity class with DataServiceKey 'CategoryName'
    ...
    // CodeFx data entity class
    public class CodeFxProjects : IUpdatable
    {
        static List<Category> categories;
        static List<Project> projects;

        // Static constructor
        static CodeFxProjects()
        {
            // Initialize the CodeFx project category list
            ...
            // Initialize the CodeFx project list
        ...
        // Public property to get the CodeFx projects information from the 
        ...
        // Public property to get the CodeFx projects categoryies information 
        ...
        public void SaveChanges()
        {
            ...
            if (tempObj != null)
            {
                ...
                if (t.Name == "Category")
                {
                    CodeFxProjects.categories.Add((Category)tempObj);
                }
                else if (t.Name == "Project")
                {
                    CodeFxProjects.projects.Add((Project)tempObj);
                }
            }
        }
