...
Public Class ServiceNative
    ...
    ByVal dwAccess As ServiceControlAccessRights) As IntPtr
    End Function
    ...
    <DllImport("advapi32.dll", CharSet:=CharSet.Auto, SetLastError:=True)> _
    Private Shared Function OpenService( _
    ByVal hSCManager As IntPtr, ByVal lpServiceName As String, _
    ByVal dwDesiredAccess As UInt32) As IntPtr
    End Function
    ...
    ByVal hService As IntPtr, ByVal dwInfoLevel As ServiceConfig2InfoLevel, _
    ...
    <Out()> ByRef pcbBytesNeeded As Integer) As Integer
    End Function
