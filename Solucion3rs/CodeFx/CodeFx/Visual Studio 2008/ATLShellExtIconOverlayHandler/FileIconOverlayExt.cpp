...
* icon overlay handler for files with "CodeFx" in the file paths. After 
* installing the icon overlay handler, any file with "CodeFx" in its file 
* path, e.g. "D:\CodeFx.txt", shows an icon overlay in Windows Explorer. 
* 
...
* 
* History:
* * 9/12/2009 7:30 PM Jialiang Ge Created
\***************************************************************************/
