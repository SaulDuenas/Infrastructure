...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	/////////////////////////////////////////////////////////////////////////
	// Create the ATLDllCOMServer.ATLSimpleObjectSTA COM object using the 
	// #import directive and smart pointers.
	// 

	CComQIPtr<IATLSimpleObjectSTA> spSimpleObj;
	hr = spSimpleObj.CoCreateInstance(OLESTR(
		"ATLDllCOMServer.ATLSimpleObjectSTA"));
	if (FAILED(hr))
	{
		_tprintf(_T(
			"IATLSimpleObjectSTAPtr.CoCreateInstance failed w/err 0x%08lx\n"
			), hr);
		return hr;
	}
