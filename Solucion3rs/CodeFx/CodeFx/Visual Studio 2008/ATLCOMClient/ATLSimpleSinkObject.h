...
* 
* History:
* * 6/18/2009 5:10 PM Jialiang Ge Created
\***************************************************************************/
...
class CATLSimpleSinkObject2 : 
	...
	&DIID__IATLSimpleObjectSTAEvents>
{
public:

	BEGIN_SINK_MAP(CATLSimpleSinkObject2)
		// Make sure the Event Handlers have __stdcall calling convention
		SINK_ENTRY_INFO(IDC_ATLSIMPLEOBJECTSTA, DIID__IATLSimpleObjectSTAEvents, 
...
public:
	...
	BEGIN_SINK_MAP(CATLSimpleSinkObject3)
		// Make sure the Event Handlers have __stdcall calling convention
		SINK_ENTRY_EX(IDC_ATLSIMPLEOBJECTSTA, DIID__IATLSimpleObjectSTAEvents, 
...
public:
	...
	HRESULT GetFuncInfoFromId(const IID& iid, DISPID dispidMember, LCID lcid, 
		_ATL_FUNC_INFO& info)
	{
		if (InlineIsEqualGUID(iid, DIID__IATLSimpleObjectSTAEvents))
		{
