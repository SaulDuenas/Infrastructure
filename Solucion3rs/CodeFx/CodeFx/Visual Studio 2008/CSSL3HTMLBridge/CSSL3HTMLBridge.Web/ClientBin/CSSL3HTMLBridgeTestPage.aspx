...
<body>
    ...
    <div id="silverlightControlHost" 
        style="width: 400px; height:400px; position: absolute; top: 0px; left: 0px;">
    ...
    <div style="border: 10px solid #FF0000; position: absolute; top: 0px; left: 400px; width: 400px; height: 380px;">
        ...
        <input id="Text1" type="text" readonly="readonly" style="width: 100%"/></td>
			</tr>
			<tr>
				<td  valign="top" style="height: 68px">
        <input id="Text2" type="text" style="width: 100%" /></td>
			</tr>
			<tr>
				<td  valign="top" style="height: 68px">
        <input id="Text3" type="text" onchange="ontext3keydown()" style="width: 100%"/></td>
			</tr>
			<tr>
				<td  valign="top">
        <input id="Text4" type="text" readonly="readonly" style="width: 100%"/></td>
			</tr>
		</table>
</div>
    </form>
