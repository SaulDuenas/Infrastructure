...
<body>
    ...
    <div>
        ...
        <asp:ImageMap ID="imgMapSolarSystem" runat="server" ImageUrl="~/solarsystem.jpg" HotSpotMode="PostBack">
        ...
        <iframe ID="ifSelectResult" runat="server" width="895" height="500" src="http://en.wikipedia.org/wiki/Solar_System"></iframe>
