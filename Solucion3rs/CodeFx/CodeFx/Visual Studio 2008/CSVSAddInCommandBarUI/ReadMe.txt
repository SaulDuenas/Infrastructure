...
1. In Menubar -> Tool menu -> CodeFx Command
2. In Toolbar -> CodeFx command
3. In Task List toolbox -> right click content menu -> CodeFx command
...
command "View.URL" to navigate Visual Studio web browser to CodeFx
home page.
