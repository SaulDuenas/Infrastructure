...
*FileController class: contains the navigation and processing logic 
	of FileDownloading function(include file list and file download)
...
*BinaryContentResult: Custom ActionResult class used for 
	output file content(as binary format)
