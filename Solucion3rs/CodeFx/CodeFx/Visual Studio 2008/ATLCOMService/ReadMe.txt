...
1. An ATL STA Simple Object short-named ATLSimpleObjectSTA.

Program ID: ATLCOMService.ATLSimpleObjectSTA
CLSID_ATLSimpleObjectSTA: 388F1C82-ED00-4966-9590-02F6B9CCA41B
IID_IATLSimpleObjectSTA: 1B877090-76CD-4EDE-8115-EC4CCD9676F3
DIID__IATLSimpleObjectSTAEvents: 7DACF5E9-2885-4E4E-83DD-CA6CC3A88B6D
...
ATLSimpleObjectSTA, and select the threading model as Apartment (corresponding
...
box. This creates the _IATLSimpleObjectSTAEvents interface in the file 
...
Step1. In Class View, find the interface IATLSimpleObjectSTA. Right click it 
...
ATLSimpleObjectSTA therefore exposes FloatProperty with the get&put accessor 
methods: get_FloatProperty, put_FloatProperty.

Step3. Add a float field, m_fField, to the class CATLSimpleObjectSTA:
...
_IATLSimpleObjectSTAEvents.

Step2. Right-click _IATLSimpleObjectSTAEvents. In the menu, click Add, and 
...
_IATLSimpleObjectSTAEvents dispinterface in the ATLExeCOMServer.idl file 
...
class CATLSimpleObjectSTA. On the shortcut menu, click Add, and then click 
Add Connection Point. Select _IATLSimpleObjectSTAEvents from the Source 
...
generated (ie. CProxy_IATLSimpleObjectSTAEvents in this sample) in the file 
_IATLSimpleObjectSTAEvents_CP.h. This also creates a function with the name
...
Step1. Open ATLSimpleObjectSTA.rgs and add the following value the 
...
The result is like
	...
	ForceRemove {388F1C82-ED00-4966-9590-02F6B9CCA41B} = 
		s 'ATLSimpleObjectSTA Class'
	{
		ProgID = s 'ATLCOMService.ATLSimpleObjectSTA.1'
		VersionIndependentProgID = s 'ATLCOMService.ATLSimpleObjectSTA'
