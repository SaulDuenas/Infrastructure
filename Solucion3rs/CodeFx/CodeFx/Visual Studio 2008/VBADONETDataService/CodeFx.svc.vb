...
' 
' History:
' * 8/9/2009 09:00 PM Lingzhi Sun Created
...
Public Class CodeFx
    Inherits DataService(Of CodeFxProjects)
    ...
    SaveChanges
        ...
        If Not tempObj Is Nothing Then
            ...
            If t.Name = "Category" Then
                CodeFxProjects._categories.Add(DirectCast(tempObj, Category))
            ElseIf t.Name = "Project" Then
                CodeFxProjects._projects.Add(DirectCast(tempObj, Project))
            End If
        End If
    End Sub
